...
const Home: React.FC = () => {
  return (
        <div className='w-full h-screen bg-[#000000] text-slate-200'> 
          <div className='max-w-[1000px] mx-auto px-8 md:px-40 flex flex-col justify-center h-full'>
            <h1 className='text-[#38b6ff]'>Hi, my name is</h1>
            ...
            <div>
              <button className='text-slate-200 border-2 px-4 py-2 my-4 flex items-center hover:bg-[#38b6ff]'>Contact
