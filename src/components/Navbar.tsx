...
const Navbar: React.FC = () => {
  ...
  return (
        <div className='fixed w-full h-[50px] flex justify-between items-center px-4 md:px-40 bg-[#000000] text-slate-200'> 
            <div>
            ...
            <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#000000] flex flex-col justify-center items-center'}>
                    ...
                    <li className='hover:text-[#38b6ff] py-5 text-2xl'>Experience</li>
            ...
            <div className='hidden md:flex fixed flex-col top-[40%] left-0'>
                <ul>
                    <li className='w-[50px] h-[40px] flex justify-between bg-[#0077B5] hover:bg-slate-200 hover:text-[#0077B5] group'>
                        <a className='flex justify-between items-center w-full' href="https://www.linkedin.com/in/chloe-h-cho/" target="_blank" rel="noopener noreferrer">
                            <FaLinkedin size={30}/>
                            <span className="absolute w-auto p-2 m-2 min-w-max left-12 rounded-md shadow-md text-slate-200 bg-[#282a33] text-xs font-bold transition-all duration-300 scale-0 origin-left group-hover:scale-100">
                                LinkedIn
                            </span>
                        </a>
                    </li>
                    <li className='w-[50px] h-[40px] flex justify-between bg-[#484f58] hover:bg-slate-200 hover:text-[#484f58] group'>
                    ...
                    <li className='w-[50px] h-[40px] flex justify-between bg-[#2b7683] hover:bg-slate-200 hover:text-[#2b7683] group'>
                    ...
                    <li className='w-[50px] h-[40px] flex justify-between bg-[#132030] hover:bg-slate-200 hover:text-[#132030] group'>
